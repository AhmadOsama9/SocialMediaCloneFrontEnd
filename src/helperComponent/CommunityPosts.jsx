...
const CommunityPosts = ({ communityId }) => {
    ...
    const { getCommunityPosts, postLoading, postError, addReaction, updateReaction, deleteReaction, addComment, updateComment, deleteComment, addShare, removeShare, deleteCommunityPost, updatePost } = usePost();
    ...
    if (communityPosts.length === 0) {
        return <h3 className="no-posts-message">The Community has no Posts</h3>;
    }
                                    ...
                                    <div className="post-header">
                                        <div className="post-author">
                                            ...
                                            <div className="author-info">
                                                <h3 className="author-name clickable" onClick={() => handleNicknameClicking(post.nickname)}>
                                                    {post.nickname}
                                                </h3>
                                            ...
                                            {post.nickname === userNickname && (
                                                <>
                                                    ...
                                                    <button 
                                                        ...
                                                        onClick={() => deleteCommunityPost(post.postId)}
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                            <path d="M3 6h18"></path>
