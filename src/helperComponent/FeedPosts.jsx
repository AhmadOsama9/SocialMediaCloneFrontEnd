...
const FeedPosts = () => {
    ...
    if (feedPosts.length === 0) {
        return <h3 className="no-posts-message">There's no Posts on your feed</h3>;
    }
                        ...
                        <div className="post-header">
                            ...
                            {post.communityName && 
                                <div className="community-info">
                                    <h3 className="community-name clickable" onClick={() => handleCommunityNameClicking(post.communityName)}>
